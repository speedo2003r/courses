...
<section class="section-padding" style="background:linear-gradient(145deg,var(--color-bg-main) 0%,var(--color-bg-subtle) 100%);">
  <div class="container container-sm" style="text-align:center;">
    <div class="reveal">
      <h1 style="margin-bottom:var(--space-md);"><?php wpm_is_rtl() ? _e('كيف يمكننا مساعدتك اليوم؟', 'edtech') : _e('How Can We Help You?', 'edtech'); ?></h1>
      <div class="input-search-wrapper" style="max-width:480px;margin-inline:auto;">
        ...
        <input type="search" class="input-field input-lg input-pill search-input" placeholder="<?php wpm_is_rtl() ? _e('كيف أحصل على شهادة الإتمام؟', 'edtech') : _e('How do I get my certificate?', 'edtech'); ?>" id="faq-search">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container container-md">
    <div class="accordion-group">
      ...
      if ( $faqs->have_posts() ) :
        ...
        <p style="color:var(--color-text-muted);text-align:center;"><?php wpm_is_rtl() ? _e('لا توجد أسئلة شائعة بعد. أضفها من لوحة التحكم.', 'edtech') : _e('No FAQ items yet. Add them from the admin.', 'edtech'); ?></p>
      <?php endif; ?>
    </div>
  </div>
</section>
